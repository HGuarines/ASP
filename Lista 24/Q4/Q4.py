...
try:
    df_fluxo = pd.read_excel(r'Tabela_fluxo4.xlsx',
                             sheet_name='fluxo_carga').fillna(0.0)
    df_ybus = pd.read_excel(r'Tabela_fluxo4.xlsx',
...
fluxo = fluxo_gauss_seidel(df_fluxo, Ybus, 4)
print(fluxo)

pd.DataFrame.to_excel(fluxo, 'resultado_fluxo4.xlsx',
