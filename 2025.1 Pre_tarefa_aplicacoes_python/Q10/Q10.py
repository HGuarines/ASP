"""10. Exemplo usando a função quad_casc(A1, B1, C1, D1, A2, B2, C2, D2)"""
...
ABCD = asp.quad_par(A1, B1, C1, D1, A2, B2, C2, D2)
...
asp.gerar_arquivo_texto('Q10.txt', 'APLICAÇÕES PYTHON', rsp10)
